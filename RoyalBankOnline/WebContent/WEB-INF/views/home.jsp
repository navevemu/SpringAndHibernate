...
<head>
 <meta charset="utf-8">
    ...
    <link rel="shortcut icon" type="image/png" href="resources/images/Rblogo.png">
...
<body>
<a href="index.html"><img src="Rblogo.png" ></a>
...
<header class="header-area">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-3 col-sm-4">
                        <div class="logo">
                            <a href="index.html"><img src="resources/images/Rblogo.png" alt=""></a>
                        </div>
                    </div>
    ...
    <div class="slider-area">
        <div class="slider-active owl-carousel">
            <div class="slider-items">
                <img src="resources/images/slider/1.jpg" alt="" class="slider">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="featured-wrap">
                        <div class="featured-img">
                            <img src="resources/images/featured/1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="featured-wrap">
                        <div class="featured-img">
                            <img src="resources/images/featured/2.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="featured-wrap">
                        <div class="featured-img">
                            <img src="resources/images/featured/3.jpg" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="about-img">
                        <img src="resources/images/about/1.jpg" alt="">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-6">
                            <div class="about-items">
                                <img src="resources/images/about/icon/1.png" alt="">
                        ...
                        <div class="col-sm-3 col-6">
                            <div class="about-items">
                                <img src="resources/images/about/icon/2.png" alt="">
                        ...
                        <div class="col-sm-3 col-6">
                            <div class="about-items mb-0">
                                <img src="resources/images/about/icon/3.png" alt="">
                        ...
                        <div class="col-sm-3 col-6">
                            <div class="about-items mb-0">
                                <img src="resources/images/about/icon/4.png" alt="">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-4 col-12">
                            <div class="test-img">
                                <img src="resources/images/test/1.png" alt="">
                            </div>
                        </div>
    ...
    <div class="expart-area">
        ...
        <div class="expart-img d-none d-lg-block">
            <img src="resources/images/bg/expart.png" alt="">
        </div>
    </div>
    <!-- expart-area end -->
    ...
    <div class="contact-area">
        ...
        <div class="contact-img d-none d-lg-block">
            <img src="resources/images/bg/2.jpg" alt="">
        </div>
    </div>
    <!-- contact-area end -->
            ...
            <div class="row">
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="nvestments-img">
                        <img src="resources/images/bg/1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
